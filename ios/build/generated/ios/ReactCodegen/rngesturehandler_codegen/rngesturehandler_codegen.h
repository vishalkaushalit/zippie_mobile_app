...
- (void)setGestureHandlerConfig:(double)handlerTag
                      newConfig:(NSDictionary *)newConfig;
- (void)updateGestureHandlerConfig:(double)handlerTag
                         newConfig:(NSDictionary *)newConfig;
- (void)configureRelations:(double)handlerTag
                 relations:(NSDictionary *)relations;
- (void)dropGestureHandler:(double)handlerTag;
- (void)flushOperations;
- (NSNumber *)installUIRuntimeBindings;
