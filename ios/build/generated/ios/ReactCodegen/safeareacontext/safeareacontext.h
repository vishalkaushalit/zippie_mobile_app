  ...
  namespace NativeSafeAreaContext {
    struct ConstantsInitialWindowMetricsInsets {
      ...
      struct Builder {
        ...
        using ResultT = ConstantsInitialWindowMetricsInsets;
...
namespace JS {
  namespace NativeSafeAreaContext {
    struct ConstantsInitialWindowMetricsFrame {
      ...
      struct Builder {
        // Backwards compat for RCTTypedModuleConstants
        using ResultT = ConstantsInitialWindowMetricsFrame;
...
namespace JS {
  namespace NativeSafeAreaContext {
    struct ConstantsInitialWindowMetrics {
      ...
      struct Builder {
        // Backwards compat for RCTTypedModuleConstants
        using ResultT = ConstantsInitialWindowMetrics;
...
- (facebook::react::ModuleConstants<JS::NativeSafeAreaContext::Constants>)constantsToExport;
- (facebook::react::ModuleConstants<JS::NativeSafeAreaContext::Constants>)getConstants;
